...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary hover:bg-blue-700 text-white focus:ring-blue-500 shadow-md shadow-blue-500/20",
    secondary: "bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 focus:ring-indigo-500",
